...
import { getQuizByModule } from '../data/moduleQuizzes';
import '../styles/ModuleQuizPage.css';

export default function ModuleQuizPage({ userName, moduleId, moduleCategory, onBack }) {
  ...
  useEffect(() => {
    const quizzes = getQuizByModule(moduleCategory);
  ...
  return (
    <div className="module-quiz-page">
...
function ModuleResultsPage({ userName, score, totalQuestions, onBack, onRetry, questions, userAnswers }) {
          ...
          <div className="results-content">
            ...
            {isPassed && (
              <div className="message-box success">
                <p>✓ Excelente! Você domina este módulo!</p>
              </div>
            )}

            {!isPassed && percentage >= 50 && (
              <div className="message-box warning">
                <p>⚠️ Bom esforço! Revise o módulo e tente novamente.</p>
              </div>
            )}

            {percentage < 50 && (
              <div className="message-box error">
                <p>❌ Estude mais o módulo e tente novamente!</p>
              </div>
            )}
